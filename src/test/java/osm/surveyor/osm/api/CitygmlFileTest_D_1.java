					...
					if (relation.getTagValue("source").endsWith("; 13111-bldg-72601")) {
						...
						for (MemberBean mem : relation.members) {
							if (mem.getRole().equals("outline")) {
								...
								assertNull(outline.getTagValue("source"), ("MLIT_PLATEAU; http://www.opengis.net/def/crs/EPSG/0/6697; 13111-bldg-72601"));
						...
						assertEquals(relation.getTagValue("ele"), ("3.1"));
						...
						for (MemberBean mem : relation.members) {
							if (mem.getRole().equals("outline")) {
								...
								assertNull(outline.getTagValue("source"), ("MLIT_PLATEAU; http://www.opengis.net/def/crs/EPSG/0/6697; 13111-bldg-71799"));
							...
							if (mem.getRole().equals("part")) {
								...
								assertEquals(way.getTagValue("ele"), ("3.1"));
