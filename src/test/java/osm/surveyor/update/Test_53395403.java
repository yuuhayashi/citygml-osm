...
public class Test_53395403 extends OsmUpdaterTest {
	...
	public void setup() {
		try {
			Files.copy(
				Paths.get("./src/test/resources/53395403_bldg_6697_op.osm"),
	 ...
	 */
	@Test
	public void test11230_1163() {
		BodyMap map = testdo(Paths.get("./53395403_bldg_6697_op.osm"));
