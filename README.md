...
- 2022-01-27 [v1.4.2-SNAPSHOT](https://github.com/yuuhayashi/citygml-osm/releases/tag/v1.4.2)
  ...
  - [Fixed #61](https://github.com/yuuhayashi/citygml-osm/issues/61) 「start_date」は既存データ優先とする
  - [Fixed #64](https://github.com/yuuhayashi/citygml-osm/issues/64) 「name」は既存データ優先とする
